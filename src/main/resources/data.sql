...
INSERT INTO cards (card_id, card_name, card_set, card_type, card_rarity, mana_cost, power, health, description) VALUES
                            (1, 'Black Lotus', 'Alpha', 'ARTIFACT', 'MYTHIC', '{0}', NULL, NULL, 'Adds 3 mana of any single color.'),
                            (2, 'Shivan Dragon', 'Alpha', 'CREATURE', 'RARE', '{4}{R}{R}', 5, 5, 'Flying, {R}: +1/+0 until end of turn.'),
                            (3, 'Lightning Bolt', 'Alpha', 'INSTANT', 'COMMON', '{R}', NULL, NULL, 'Lightning Bolt deals 3 damage to any target.'),
                            (4, 'Sol Ring', 'Alpha', 'ARTIFACT', 'UNCOMMON', '{1}', NULL, NULL, '{T}: Add {C}{C}.'),
                            (5, 'Forest', 'Zendikar', 'LAND', 'COMMON', '', NULL, NULL, '{T}: Add {G}.');
...
-- 4. Fyld kort i samlingerne (Collection Items)
...
-- Kaj har en Black Lotus (heldige asen) og nogle skove
INSERT INTO collection_items (collection_id, card_id, quantity, card_condition) VALUES
...
INSERT INTO decks (user_id, deck_name, deck_format, commander_card_id) VALUES
                            (3, 'Sørens Burn Deck', 'STANDARD', NULL), -- Deck ID 1
                            (3, 'Dragon Commander', 'COMMANDER', 2);   -- Deck ID 2 (Shivan Dragon er commander)
...
-- 7. Tilmeld brugere til Events (Event Registrations)
